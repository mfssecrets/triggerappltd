package com.trigger.app.chats.presentation.actual_chat.screens.view_image
...
class ViewImageViewModel : ViewModel() {
    ...
    fun downloadImage(imageUrl: String, context: Context) = viewModelScope.launch {
        ...
        val fileName = "IMG-${jodaTime.year}${jodaTime.monthOfYear}${jodaTime.dayOfMonth}-Trigger App${jodaTime.millisOfDay}"
